    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            DrawerContent(onNavigate = { destination ->
                ...
                if (destination == "home" || destination == "hizb_al_falah" || destination == "hadra" || destination == "yaqouta" || destination == "tasbih" || destination == "silsila_chooser" || destination == "tassawof" || destination == "museum_kotob" || destination == "museum_rasail") {
        ...
        NavHost(navController = navController, startDestination = "home") {
            ...
            composable("museum_kotob") {
                MuseumScreen(title = "كتب", items = com.cheikhiyya.tariqa.data.MUSEUM_KOTOB, onBack = { navController.popBackStack() })
            }

            composable("museum_rasail") {
                MuseumScreen(title = "رسائل", items = com.cheikhiyya.tariqa.data.MUSEUM_RASAIL, onBack = { navController.popBackStack() })
            }

            composable("tassawof") {
                TassawofScreen(onBack = { navController.popBackStack() })
            }
            ...
            composable("silsila_chooser") {
                SilsilaChooserScreen(
                    onBack = { navController.popBackStack() },
                    onChoose = { choice -> navController.navigate(choice) },
                )
            }
