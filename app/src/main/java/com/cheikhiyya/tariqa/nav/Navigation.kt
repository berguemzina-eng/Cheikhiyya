    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            DrawerContent(onNavigate = { destination ->
                ...
                if (destination == "home" || destination == "hizb_al_falah" || destination == "hadra" || destination == "yaqouta" || destination == "tasbih" || destination == "silsila_chooser" || destination == "tassawof") {
