 ...
 *  - un enlace externo (externalUrl != null), que abre el navegador —
 *    igual que los enlaces a redes sociales.
 * Todo el contenido nativo vive en este mismo proceso: no hay llamadas
 * de red salvo cuando el propio usuario elige abrir un enlace externo.
 */
data class MenuNode(
    val id: String,
    val title: String,
