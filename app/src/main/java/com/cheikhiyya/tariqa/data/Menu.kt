...
val MENU: List<MenuNode> = listOf(
    ...
    MenuNode(
        ...
        children = listOf(
            ...
            MenuNode(id = "sidi_ahmed_majdoub", title = "سيدي أحمد المجذوب", articleId = pending("سيدي أحمد المجذوب")),
            MenuNode(id = "lalla_safia", title = "للا صفية", articleId = pending("للا صفية")),
        ),
    ),
