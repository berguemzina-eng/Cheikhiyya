...
val MENU: List<MenuNode> = listOf(
    ...
    MenuNode(
        ...
        children = listOf(
            ...
            MenuNode(id = "shuyukh_baad_sidi_abdelkader", title = "شيوخ الطريقة بين المؤسس وسيدي بوعمامة", articleId = "shuyukh_baad_sidi_abdelkader"),
    ...
    MenuNode(id = "golden_book", title = "الكتاب الذهبي", icon = "goldbook", externalUrl = "https://www.facebook.com/groups/cheikhiyya/"),
