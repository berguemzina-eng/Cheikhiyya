// حزب الفلاح — نص كامل (وِرد من أوراد الطريقة الشيخية الشاذلية)
// Fuente: www.cheikhiyya.com/Hizb-Al-Falah.php
// Cada elemento: texto del dhikr + número de repeticiones (si aplica).

export const HIZB_AL_FALAH_INTRO = {
  istiadha: 'أعُوذُ بِاللهِ السَّمِيعِ العَلِيمِ مِنَ الشَيْطَانِ الرَجِيمِ',
  basmala:
...
export const HIZB_AL_FALAH = [
  { text: 'تَوَكَّلْتُ عَلَى الحَيِّ الذِي لا يَمُوتُ', repeat: 2 },
  { text: 'تَوَكَّلْنَا عَلَى الحَيِّ الذِي لا يَمُوتُ', repeat: 1 },
  {
    text:
  ...
  {
    text: 'جَزَى اللهُ عَنَّا سَيِّدَنَا وَنَبِيَّنَا مُحَمَّدًا صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ أَفْضَلَ مَا هُوَ أَهْلُهُ',
    repeat: 3,
  },
  {
    text:
  ...
  { text: 'أَعُوذُ بِكَلِمَاتِ اللهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ', repeat: 3 },
  {
    text:
  ...
  {
    text: 'سُبْحَانَ رَبِّيَ العَظِيمِ وَبِحَمْدِهِ وَلاَ حَوْلَ وَلاَ قُوَةَ إلا بِاللهِ العَلِيِّ العَظِيمِ',
    repeat: 3,
  },
  {
    text:
  ...
  {
    text: 'لاَ إلهَ إلاَ اللهُ سَيِّدُنَا مُحَمَّدٌ رَسُولُ اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ وَعَلَى آلِهِ',
    repeat: 9,
  },
  {
    text: 'لاَ إلهَ إلاَ اللهُ شَفِيعُنَا رَسُولُ اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ وَعَلَى آلِهِ',
    repeat: 1,
  },
  {
    text:
  ...
  {
    text: 'إنَّ اللهَ وَمَلائِكَتَهُ يُصَلُّونَ عَلَى النَّبِي يَاأيُّهَا الذِينَ أمَنُوا صَلُّوا عَلَيْهِ وَسَلِّمُوا تَسْلِيمَا.',
    repeat: 1,
  },
  {
    text: 'اللَّهُمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى آلِهِ كَمَا لا نِهَايَةَ لِكَمَالِكَ وَعَدَّ كَمَالِهِ',
    repeat: 24,
  },
  {
    text: 'اللَّهُمَّ صَلِّ عَلَى المُصْطَفَى مُحَمَّدٍ وَعَلَى آلِهِ كَمَا لا نِهَايَةَ لِكَمَالِكَ وَعَدَّ كَمَالِهِ',
    repeat: 1,
  },
  {
    text:
  ...
  { text: 'اللَّهُمَ شَفِّعْهُ فِينَا بِجَاهِهِ عِنْدَكَ', repeat: 2 },
  { text: 'اللَّهُمَ حَنِّنْهُ فِينَا بِجَاهِهِ عِنْدَكَ يَااللهُ.', repeat: 1 },
  {
    text: 'سُبْحَانَ رَبِّكَ رَبِّ العِزَّةِ عَمَّا يَصِفُونَ، وَسَلامٌ عَلَى المُرْسَلِينَ، وَالحَمْدُ للهِ رَبِّ العَالَمِينَ.',
    repeat: 1,
  },
];

export const HIZB_AL_FALAH_NOTE =
...
export const HIZB_AL_FALAH_SOURCE = 'تحقيق خادم الطريقة الشيخية مصطفى حاكمي';
